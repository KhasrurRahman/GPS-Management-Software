            ...
            <div class="card card-primary card-outline">
                <div class="card-body box-profile">
                    ...
                    <ul class="list-group list-group-unbordered mb-3">
                        ...
                        <li class="list-group-item">
                            <b>Take a Note</b><br>
                            <textarea name="user_note" id="user_note" rows="5" style="width: 100%"
                                      onkeyup="take_note($(this).val(),{{$user->id}})">{{$user->note}}</textarea>
                        </li>
                    </ul>
                        ...
                        <div class="tab-pane" id="settings">
                            <form class="form-horizontal" action="{{route('update_user_info',$user->user_id)}}" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="par_add" name="par_add" placeholder="Enter your address details"
                                               autocomplete="off" value="{{$user->par_add}}" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input type="text" pattern=".{11,11}" max="11" class="form-control" id="phone" name="phone"
                                               placeholder="Enter your mobile number" autocomplete="off" value="{{$user->phone}}" required>
                                        @if ($errors->has('phone'))
                ...
                <form action="{{route('admin.update_payment',$user->id)}}" method="post">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="month" placeholder="Number Of Months" name="number_of_months"
                ...
                <form action="{{route('admin.monthly_bill_update',$user->id)}}" method="post">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="month" placeholder="Number Of Months" name="monthly_bill"
                                   value="{{$user->monthly_bill}}">
                        </div>
                ...
                <div class="modal-body">
                    <form role="form" action="{{route('admin.update_user_after_mistake')}}" method="post">
                        ...
                        <div class="row">
                            ...
                            <input type="hidden" pattern=".{11,11}" max="11" class="form-control" id="phone" placeholder="Phone" name="phone"
                                   value="{{$user->phone}}">
                            ...
                            <input type="hidden" class="form-control" id="Email" placeholder="installation Date" name="installation_date"
                                   value="{{$user->installation_date}}">


                            <input type="hidden" class="form-control" placeholder="Device Price" name="device_price" value="{{$user->device_price}}">


                            <input type="hidden" class="form-control" id="Present Address" placeholder="Monthly Bill" name="monthly_bill"
                                   value="{{$user->monthly_bill}}">
