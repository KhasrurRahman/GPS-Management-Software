...
@section('content')
    ...
    <div class="tm-section tm-checkout-area bg-white tm-padding-section">
        <div class="container">
            <form action="{{route('guest_user_register_order',$package->id)}}" class="tm-form tm-checkout-form" method="post">
                @csrf
                <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="par_add" name="par_add" placeholder="Enter your address details"
                                               autocomplete="off" value="{{ old('par_add') }}">
                                ...
                                <div class="col-sm-12 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" id="email" name="email" placeholder="Enter your valid email address"
                                ...
                                <div class="col-sm-12 col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Vehicle Brand & Model" id="car_model" name="car_model"
                                               value="{{ old('car_model') }}">
                            ...
                            <div class="tm-checkout-payment">
                                ...
                                <div class="tm-form-inner">
                                    <div class="tm-form-field">
                                        ...
                                        <label for="checkout-payment-cashondelivery">Online Payment</label>
                                    </div>
                                </div>
                            </div>
