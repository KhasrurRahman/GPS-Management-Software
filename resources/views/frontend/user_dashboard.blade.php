                    ...
                    <div class="card card-primary card-outline h-100">
                        <div class="card-body box-profile">
                            <div class="text-center">
                                <img class="profile-user-img img-fluid img-circle" src="{{asset('public/assets/backend/img/avatar5.png')}}"
                                     alt="User profile picture" style="border-radius: 20%">
                            </div>
                            ...
                            <a href="" data-toggle="modal" class="btn btn-warning btn-block" data-target="#post_a_complain"
                               style="color: white;font-weight: bold;">Place a Complain</a>
                        </div>
                        <!-- /.card-body -->
                    </div>
                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            @elseif($data->order_status == 1)
                                                                <span class="right badge badge-warning">Complete</span>
                                                            @endif
                                                        </td>
                                ...
                                <div class="tab-pane" id="settings">
                                    <form class="form-horizontal" action="{{route('update_user_info',$user_info->user_id)}}" method="post">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="inputName" placeholder="Name" value="{{$user_info->name}}"
                                                       name="name" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="email" class="form-control" id="inputEmail" value="{{$user_info->email}}" autocomplete="off"
                                                       name="email">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="par_add" name="par_add" placeholder="Enter your address details"
                                                       autocomplete="off" value="{{$user_info->par_add}}" required>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <input type="text" pattern=".{11,11}" max="11" class="form-control" id="phone" name="phone"
                                                       placeholder="Enter your mobile number" autocomplete="off" value="{{$user_info->phone}}" required
                                                       readonly>
                                            </div>
                                        </div>
