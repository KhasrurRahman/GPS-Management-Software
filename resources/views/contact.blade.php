        ...
        <div class="col-md-12">
            <div class="row">
                <div class="container register-form">
                    <div class="form">
                        <form action="{{route('user_complain_save')}}" method="post">
                            @csrf
                            <div class="note">
                                <p style="font-weight: 600; font-size: 25px">Place Your Complain here</p>
                            </div>
                            <div class="card">
                                ...
                                <div class="form-content">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-lg-12">
                                            <div class="form-group">
                                                <label for="message">Your Complain</label>
                                                <textarea class="form-control" name="complain" id="message" rows="3" placeholder="Write your complain" required=""></textarea>
                                            </div>
                                        </div>
